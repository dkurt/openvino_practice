...
class Tracker:
    ...
    def _calc_affinity_appearance(self, track, obj):
        raise NotImplemented("The function _calc_affinity_appearance  is not implemented -- implement it by yourself")

    def _calc_affinity_position(self, track, obj):
        raise NotImplemented("The function _calc_affinity_position is not implemented -- implement it by yourself")

    def _calc_affinity_shape(self, track, obj):
        raise NotImplemented("The function _calc_affinity_shape is not implemented -- implement it by yourself")
